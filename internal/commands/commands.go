...
var Builtins = []Definition{{"settings", "Open settings menu", ""}, {"model", "Select model", "<provider/model>"}, {"tree", "Navigate session tree", ""}, {"thinking", "Set thinking level", "<level>"}, {"export", "Export session", "[path]"}, {"import", "Import a JSONL session", "<path>"}, {"copy", "Copy last agent message", ""}, {"name", "Set session display name", "<name>"}, {"session", "Show session info and stats", ""}, {"fork", "Create a session fork", ""}, {"clone", "Clone the current session", ""}, {"login", "Configure provider authentication", "<provider>"}, {"logout", "Remove provider authentication", "<provider>"}, {"new", "Start a new session", ""}, {"compact", "Compact session context", ""}, {"resume", "Resume a different session", ""}, {"reload", "Reload context and settings", ""}, {"quit", "Quit Piapple", ""}}
